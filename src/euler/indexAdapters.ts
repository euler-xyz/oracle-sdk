...
const abi = parseAbi([
  ...
  'function pauseTimeBefore() view returns (uint256)',
  'function pauseTimeAfter() view returns (uint256)',
  'function maxAllowedMultiplierChange() view returns (uint256)',
  'function xStocksToken() view returns (address)',
